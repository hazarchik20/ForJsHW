...
for (let i = 0; i < products.length; i++) {
    ...
    discountPercentage.textContent = products[i].discountPercentage + " %";
    ...
    console.log(`product with id:${products[i].id} added`);
    };

    card.append(thumbnail, discountPercentage, category, title, description, price, cartBtn);

    container.appendChild(card);

    console.log(`product ${products[i].id} added`);
}
